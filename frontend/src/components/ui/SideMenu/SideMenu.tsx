...
const SideMenu = ({ isOpen, toggle }: Props) => {
    ...
    return (
        <aside className={`flex flex-col w-full max-w-sm lg:w-80 h-screen shadow-xl fixed z-50 ${isOpen ? "left-0" : "-left-full"} lg:left-0 top-0 bottom-0 overflow-y-auto overflow-x-hidden`} style={{ transition: "left 400ms" }}>
            {/* close menu on mobile */}
            <button onClick={() => toggle()} className="lg:hidden absolute top-4 left-4 text-white">
            ...
            <div className="h-80 w-full bg-primary-100 p-8 pb-0">
                ...
                <div className="text-center p-0">
                    ...
                    <span className="text-gray-50 text-xs mt-2 block">CTI Social Network</span>
                </div>
